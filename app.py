...
# Flask route to generate and download the document
@app.route("/")
def home():
    return """
    <h2>Mediation Form Generator</h2>
    <p>Click below to generate the document.</p>
    <a href="/generate">Generate Document</a>
    """

@app.route("/generate")
def generate():
    output_path = "output/Mediation_Form.docx"
